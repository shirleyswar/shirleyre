...
function NavRibbon({
  ...
  return (
    ...
    >
      ...
      {/* CONTACTS nav card — blue, same orbit style as LIFE/ENTITIES/PORTFOLIO */}
      <motion.button
        ...
        style={{
          ...
          maxWidth: 160,
          height: 'clamp(80px, 14vw, 96px)',
          background: 'linear-gradient(135deg, #0d1a2e 0%, #0f1e36 50%, #0c1929 100%)',
          border: '1px solid rgba(59,130,246,0.32)',
          borderRadius: 16,
          cursor: 'pointer',
          overflow: 'hidden',
          boxShadow: '0 4px 20px rgba(0,0,0,0.6), 0 0 12px rgba(59,130,246,0.12), inset 0 1px 0 rgba(79,142,247,0.06)',
          userSelect: 'none',
          WebkitUserSelect: 'none',
          fontFamily: 'inherit',
        }}
      >
        ...
        <div style={{ position: 'relative', width: 'clamp(40px, 8vw, 54px)', height: 'clamp(40px, 8vw, 54px)', flexShrink: 0 }}>
          <motion.div
            style={{ position: 'absolute', inset: 0, borderRadius: '50%', border: '1px solid rgba(59,130,246,0.28)' }}
            animate={{ scale: [1, 1.45, 1], opacity: [0.45, 0, 0.45] }}
            transition={{ duration: 2.8, repeat: Infinity, ease: 'easeInOut' }}
          />
          <motion.div
            style={{ position: 'absolute', inset: 8, borderRadius: '50%', border: '1px solid rgba(59,130,246,0.45)' }}
            animate={{ scale: [1, 1.25, 1], opacity: [0.6, 0.08, 0.6] }}
            transition={{ duration: 2.8, repeat: Infinity, ease: 'easeInOut', delay: 0.55 }}
          />
          <motion.div
            animate={{ boxShadow: ['0 0 8px rgba(59,130,246,0.25)', '0 0 22px rgba(59,130,246,0.55)', '0 0 8px rgba(59,130,246,0.25)'] }}
            transition={{ duration: 2.8, repeat: Infinity, ease: 'easeInOut' }}
            style={{
              position: 'absolute', inset: 16, borderRadius: '50%',
